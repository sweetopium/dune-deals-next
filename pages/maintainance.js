                        ...
                        <div className="col-lg-6">
                            <div className="maintainance-left pdr80">
                                ...
                                <div className="heading">
                                    <h2 className="heading-title size-xl">Under <br /> Construction!</h2>
                                    <div className="heading-desc">To make somethings right we need some time to rebuild. Get notified when we are done.</div>
                                </div>
                                <form action="#">
