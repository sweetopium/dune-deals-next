export default function Dating_Section1() {
    return (
        <>
            <section className="section has-shape background-yellow  opb120 relative overflow-hidden">
                <div className="container">
                    <div className="row flex-align-c">
                        <div className="col-lg-6">
                            <div className="spdtb pdr50">
                                <div className="heading heading-alway-dark mb32">
                                    <div className="heading-sub">DuneDeals</div>
                                    <h2 className="heading-title size-xl">Daily savings on Dubai's top offers, events &
                                        coupons!</h2>
                                </div>
                        ...
                        <div className="col-lg-6">
                            <div className="images layout-10 lg-mt60">
                                <div className="inner">
                                    <img className="" src="/assets/images/Onboarding - 4.png" alt=""/>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div className="shape-bottom h50">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 283.5 27.8" preserveAspectRatio="none">
                        <path fill="var(--sala-neutral-white)"
